    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-primary-50/30 to-accent-50/20">
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xl text-muted-foreground">
                Welcome back, {entityProfile?.officer?.name || 'Procurement Officer'}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <Card className="lg:col-span-6 border-border/50 bg-card/80 backdrop-blur-sm shadow-lg hover:shadow-card-hover transition-all duration-300">
            <CardHeader className="pb-6">
              <CardTitle className="flex items-center gap-3">
                <div className="p-2 bg-gradient-to-br from-primary to-primary-600 rounded-lg shadow-blue-glow">
                  <Building2 className="h-5 w-5 text-primary-foreground" />
                </div>
                <span className="text-xl font-semibold">Organization Profile</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <p className="text-lg font-semibold text-foreground">{entityProfile?.name}</p>
                  <p className="text-sm text-muted-foreground font-medium">{entityProfile?.type}</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-base font-semibold text-foreground">{entityProfile?.code}</p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">Procurement Threshold</p>
                  <p className="text-base font-semibold text-primary">{formatCurrency(entityProfile?.procurementThreshold || 0)}</p>
                </div>
              </div>
              ...
              <div className="border-t border-border pt-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-base font-semibold text-foreground">{entityProfile?.officer?.name}</span>
                </div>
