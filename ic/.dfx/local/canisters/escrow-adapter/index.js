...
import { idlFactory } from './escrow-adapter.did.js';
export { idlFactory } from './escrow-adapter.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ESCROW_ADAPTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./escrow-adapter.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the escrow-adapter canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./escrow-adapter.did.js")._SERVICE>}
 */
export const escrow_adapter = createActor(canisterId);
