...
import { idlFactory } from './audit.did.js';
export { idlFactory } from './audit.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUDIT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./audit.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the audit canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./audit.did.js")._SERVICE>}
 */
export const audit = createActor(canisterId);
